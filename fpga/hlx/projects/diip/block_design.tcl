...
connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins rst_temac_support_0_125M/ext_reset_in]
...
connect_bd_net -net rst_temac_support_0_125M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_master_burst_0/m_axi_aresetn] [get_bd_pins axi_master_burst_1/m_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins rst_temac_support_0_125M/peripheral_aresetn] [get_bd_pins temac_support_0/axi_tresetn] [get_bd_pins uft_stack_0/rst_n]
connect_bd_net -net rst_temac_support_0_125M_peripheral_reset [get_bd_pins debounce_0/rst] [get_bd_pins impulse_generator_0/rst] [get_bd_pins rst_temac_support_0_125M/peripheral_reset] [get_bd_pins temac_support_0/glbl_rst] [get_bd_pins udp_ip_stack_0/reset]
...
connect_bd_net -net temac_support_0_gtx_clk_bufg_out [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_master_burst_0/m_axi_aclk] [get_bd_pins axi_master_burst_1/m_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins debounce_0/clk] [get_bd_pins impulse_generator_0/clk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins rst_temac_support_0_125M/slowest_sync_clk] [get_bd_pins temac_support_0/axi_tclk] [get_bd_pins temac_support_0/gtx_clk_bufg_out] [get_bd_pins udp_ip_stack_0/rx_clk] [get_bd_pins udp_ip_stack_0/tx_clk] [get_bd_pins uft_stack_0/clk]

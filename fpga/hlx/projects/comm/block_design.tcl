  ...
  connect_bd_intf_net -intf_net jtag_axi_data_M_AXI [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins jtag_axi_data/M_AXI]
  ...
  connect_bd_intf_net -intf_net jtag_axi_wctrl_axi_periph_M00_AXI [get_bd_intf_pins jtag_axi_wctrl_axi_periph/M00_AXI] [get_bd_intf_pins uft_stack/s_axi_ctrl]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets uft_stack_m_axi_rx] [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins system_ila_1/SLOT_0_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets uft_stack_m_axi_rx]
  connect_bd_intf_net -intf_net uft_stack_m_axi_tx [get_bd_intf_pins axi_smc/S02_AXI] [get_bd_intf_pins uft_stack/m_axi_tx]
connect_bd_intf_net -intf_net [get_bd_intf_nets uft_stack_m_axi_tx] [get_bd_intf_pins axi_smc/S02_AXI] [get_bd_intf_pins system_ila_1/SLOT_1_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets uft_stack_m_axi_tx]
  ...
  connect_bd_net -net rst_temac_support_125M_peripheral_aresetn [get_bd_pins axi_bram/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins jtag_axi_data/aresetn] [get_bd_pins jtag_axi_wctrl/aresetn] [get_bd_pins jtag_axi_wctrl_axi_periph/M00_ARESETN] [get_bd_pins jtag_axi_wctrl_axi_periph/S00_ARESETN] [get_bd_pins rst_temac_support/peripheral_aresetn] [get_bd_pins system_ila_1/resetn] [get_bd_pins temac_support/axi_tresetn] [get_bd_pins uft_stack/m_axi_rx_aresetn] [get_bd_pins uft_stack/m_axi_tx_aresetn] [get_bd_pins uft_stack/rst_n] [get_bd_pins uft_stack/s_axi_ctrl_aresetn]
  connect_bd_net -net rst_temac_support_interconnect_aresetn [get_bd_pins jtag_axi_wctrl_axi_periph/ARESETN] [get_bd_pins rst_temac_support/interconnect_aresetn]
  ...
  connect_bd_net -net temac_support_gtx_clk_bufg_out [get_bd_pins axi_bram/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins jtag_axi_data/aclk] [get_bd_pins jtag_axi_wctrl/aclk] [get_bd_pins jtag_axi_wctrl_axi_periph/ACLK] [get_bd_pins jtag_axi_wctrl_axi_periph/M00_ACLK] [get_bd_pins jtag_axi_wctrl_axi_periph/S00_ACLK] [get_bd_pins rst_temac_support/slowest_sync_clk] [get_bd_pins system_ila_1/clk] [get_bd_pins temac_support/axi_tclk] [get_bd_pins temac_support/gtx_clk_bufg_out] [get_bd_pins udp_ip_stack/rx_clk] [get_bd_pins udp_ip_stack/tx_clk] [get_bd_pins uft_stack/clk] [get_bd_pins uft_stack/m_axi_rx_aclk] [get_bd_pins uft_stack/m_axi_tx_aclk] [get_bd_pins uft_stack/s_axi_ctrl_aclk]
  ...
  connect_bd_net -net uft_stack_rx_done [get_bd_ports led3] [get_bd_pins system_ila_1/probe0] [get_bd_pins uft_stack/rx_done]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00000000 [get_bd_addr_spaces jtag_axi_wctrl/Data] [get_bd_addr_segs uft_stack/s_axi_ctrl/reg0] SEG_uft_stack_reg0

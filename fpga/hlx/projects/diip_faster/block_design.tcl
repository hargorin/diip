  ...
  set wallis_0 [ create_bd_cell -type ip -vlnv ime:diip:wallis:1.0 wallis_0 ]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_intf_net -intf_net diip_controller_0_wa_o_axis [get_bd_intf_pins diip_controller_0/wa_o_axis] [get_bd_intf_pins wallis_0/i_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets diip_controller_0_wa_o_axis] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS] [get_bd_intf_pins wallis_0/i_axis]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets diip_controller_0_wa_o_axis]
  connect_bd_intf_net -intf_net div_gen_0_M_AXIS_DOUT [get_bd_intf_pins div_gen_0/M_AXIS_DOUT] [get_bd_intf_pins wallis_0/s_axis_dout]
connect_bd_intf_net -intf_net [get_bd_intf_nets div_gen_0_M_AXIS_DOUT] [get_bd_intf_pins div_gen_0/M_AXIS_DOUT] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets div_gen_0_M_AXIS_DOUT]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_intf_net -intf_net wallis_0_m_axis_dividend [get_bd_intf_pins div_gen_0/S_AXIS_DIVIDEND] [get_bd_intf_pins wallis_0/m_axis_dividend]
connect_bd_intf_net -intf_net [get_bd_intf_nets wallis_0_m_axis_dividend] [get_bd_intf_pins div_gen_0/S_AXIS_DIVIDEND] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets wallis_0_m_axis_dividend]
  connect_bd_intf_net -intf_net wallis_0_m_axis_divisor [get_bd_intf_pins div_gen_0/S_AXIS_DIVISOR] [get_bd_intf_pins wallis_0/m_axis_divisor]
connect_bd_intf_net -intf_net [get_bd_intf_nets wallis_0_m_axis_divisor] [get_bd_intf_pins div_gen_0/S_AXIS_DIVISOR] [get_bd_intf_pins system_ila_0/SLOT_6_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets wallis_0_m_axis_divisor]
  connect_bd_intf_net -intf_net wallis_model_0_o_axis [get_bd_intf_pins diip_controller_0/wa_i_axis] [get_bd_intf_pins wallis_0/o_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets wallis_model_0_o_axis] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS] [get_bd_intf_pins wallis_0/o_axis]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets diip_controller_0_wa_par_b_gmean]
  connect_bd_net -net diip_controller_0_wa_par_bi [get_bd_pins diip_controller_0/wa_par_bi] [get_bd_pins system_ila_0/probe5] [get_bd_pins wallis_0/wa_par_bi]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets diip_controller_0_wa_par_bi]
  connect_bd_net -net diip_controller_0_wa_par_c [get_bd_pins diip_controller_0/wa_par_c] [get_bd_pins system_ila_0/probe2] [get_bd_pins wallis_0/wa_par_c]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets diip_controller_0_wa_par_c]
  connect_bd_net -net diip_controller_0_wa_par_c_gvar [get_bd_pins diip_controller_0/wa_par_c_gvar] [get_bd_pins system_ila_0/probe1] [get_bd_pins wallis_0/wa_par_c_gvar]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets diip_controller_0_wa_par_c_gvar]
  connect_bd_net -net diip_controller_0_wa_par_ci_gvar [get_bd_pins diip_controller_0/wa_par_ci_gvar] [get_bd_pins system_ila_0/probe3] [get_bd_pins wallis_0/wa_par_ci_gvar]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets diip_controller_0_wa_par_ci_gvar]
  ...
  connect_bd_net -net rst_temac_support_125M_peripheral_aresetn [get_bd_pins diip_controller_0/rst_n] [get_bd_pins rst_temac_support/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins temac_support/axi_tresetn] [get_bd_pins uft_stack/rst_n] [get_bd_pins wallis_0/rst_n]
  ...
  connect_bd_net -net temac_support_gtx_clk_bufg_out [get_bd_pins diip_controller_0/clk] [get_bd_pins div_gen_0/aclk] [get_bd_pins rst_temac_support/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins temac_support/axi_tclk] [get_bd_pins temac_support/gtx_clk_bufg_out] [get_bd_pins udp_ip_stack/rx_clk] [get_bd_pins udp_ip_stack/tx_clk] [get_bd_pins uft_stack/clk] [get_bd_pins wallis_0/clk]

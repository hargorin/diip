...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net diip_controller_0_uft_tx_data_size [get_bd_pins diip_controller_0/uft_tx_data_size] [get_bd_pins system_ila_0/probe8] [get_bd_pins uft_stack/tx_data_size]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net diip_controller_0_uft_tx_start [get_bd_pins diip_controller_0/uft_tx_start] [get_bd_pins system_ila_0/probe6] [get_bd_pins uft_stack/tx_start]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets diip_controller_0_uft_tx_start]
  connect_bd_net -net diip_controller_0_wa_par_b_gmean [get_bd_pins diip_controller_0/wa_par_b_gmean] [get_bd_pins system_ila_0/probe4] [get_bd_pins wallis_model_0/wa_par_b_gmean]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets diip_controller_0_wa_par_b_gmean]
  connect_bd_net -net diip_controller_0_wa_par_bi [get_bd_pins diip_controller_0/wa_par_bi] [get_bd_pins system_ila_0/probe5] [get_bd_pins wallis_model_0/wa_par_bi]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets diip_controller_0_wa_par_bi]
  connect_bd_net -net diip_controller_0_wa_par_c [get_bd_pins diip_controller_0/wa_par_c] [get_bd_pins system_ila_0/probe2] [get_bd_pins wallis_model_0/wa_par_c]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets diip_controller_0_wa_par_c]
  connect_bd_net -net diip_controller_0_wa_par_c_gvar [get_bd_pins diip_controller_0/wa_par_c_gvar] [get_bd_pins system_ila_0/probe1] [get_bd_pins wallis_model_0/wa_par_c_gvar]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets diip_controller_0_wa_par_c_gvar]
  connect_bd_net -net diip_controller_0_wa_par_ci_gvar [get_bd_pins diip_controller_0/wa_par_ci_gvar] [get_bd_pins system_ila_0/probe3] [get_bd_pins wallis_model_0/wa_par_ci_gvar]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \

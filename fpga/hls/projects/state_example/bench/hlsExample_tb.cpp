...
int main(int argc, char *argv[])
{
	...
	// In files
	const char* a1 = "in.dat";
	const char* a2 = "queryReply.dat";
	const char* a3 = "gold.dat";
	const char* a4 = "out.dat";
	...
	cerr << "Input File: " << a1 << endl << "Output File: " << a4  << endl << endl;
	...
	for (int i = 0; i < count + 30; i++) {
		hlsExample(inDataFIFO, inQueryIP, outDataFIFO, outReplyMAC);
		cerr << ".";
	}

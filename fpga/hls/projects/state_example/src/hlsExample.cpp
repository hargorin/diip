...
#include "../inc/ip_handler.hpp"
#include "../inc/arp_reply.hpp"
#include "../inc/icmp_server.hpp"
#include "../inc/loopback.hpp"
#include "../inc/merge.hpp"

void hlsExample(stream<axiWord> &inData, stream<ap_uint<32> > &queryIP, stream<axiWord> &outData, stream<ap_uint<48> > &returnMAC) {

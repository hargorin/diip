...
set_directive_array_partition -type cyclic -factor 2 -dim 1 "wallis" pixel
...
set_directive_pipeline "wallis/loop_while"
set_directive_resource -core RAM_S2P_LUTRAM "wallis" pixel

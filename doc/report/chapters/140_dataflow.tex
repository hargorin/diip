...
\todo[inline]{How many clock cycles??}
\vspace{1ex}
...
that now the behaviour was not described in C language but in VHDL. The total
...
time in understanding how the synthesis tool translated the C code (referring
...
\begin{figure}[tb!]
    \centering
    % \includegraphics[width=0.6\textwidth]{images/controller/tracesolb.png}

...
show the results of the throughput measurements. The missing valud for HLS 8bit
...
The increase of throughput over image height can be explained by the way the
controller works. \todo{Why exactly is that the case??}
...
\begin{table}[tb!]
    ...
    \begin{tabular}{l l l l l}
        ...
        HLS 256bit & 1.909 & 1.909 & 1.909 & 1.909 \\
...
With all three FPGA implementations compared, the main limit in throughput is
how the data is transfered to the FPGA. 
...
\begin{figure}[tb!]
    ...
    \end{adjustbox}
    \caption{Theoretical throughput of FPGA versus CPU}

...
\todo[inline]{NH: Is this list stil valid?}
\begin{itemize}
...
\textbf{Image processing}
    \begin{itemize}
        \item The border pixels are not considered. The destination image will be smaller than the source image. \todo{begruendung?}

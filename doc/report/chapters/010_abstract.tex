...
In a first attempt High level synthesis was used to describe a Wallis local contrast enhancment filter
...
Protocol (UDP) to transfer the images from a computer to the FPGA. 
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% Results:
The processing core takes image data from FPGA block memory and processes data at
one

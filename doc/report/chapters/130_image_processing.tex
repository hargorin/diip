...
oldest pixels from the sum of the pixels, as shown in figure \ref{fig:sequence}. Therefore, this path goes to the minus output. \\
...
\begin{figure}[tb!]
    ...
    {images/image_processing/dir_shift_reg.png}
    \caption{Simulation of the dir\_shift\_reg displays the two outputs}
    \label{fig:ac701}
\end{figure}

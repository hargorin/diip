...
\documentclass[a4paper,11pt,leqno,openbib,twoside]{memoir} %add 'draft' to turn draft option on (see below)
%
%
% Adding metadata:
\usepackage{datetime}
...
% <<< ---------------------------------------------------------- COMMUNICATION %
\input{chapters/140_communication}
% ------------------------------------------------------------------------->>> %

% <<< ----------------------------------------------------------- VERIFICATION %
\input{chapters/150_verification}
% ------------------------------------------------------------------------->>> %

% <<< ------------------------------------------------------------- CONCLUSION %
\input{chapters/160_conclusion}
% ------------------------------------------------------------------------->>> %
...
% % <<< ------------------------------------------------------- FOLDER STRUCTURE %
% \input{chapters/210_folder_structure}
% % ------------------------------------------------------------------------->>> %

% % <<< ---------------------------------------------------------- BUILD PROCESS %
% \input{chapters/220_build_process}
% % ------------------------------------------------------------------------->>> %

% % <<< ------------------------------------------------------------- VIVADO HLS %
% \input{chapters/230_vivado_hls}
% % ------------------------------------------------------------------------->>> %

% % <<< --------------------------------------------------------- HDL SIMULATION %
% \input{chapters/240_hdl_simulation}
% % ------------------------------------------------------------------------->>> %

% % <<< --------------------------------------------------------- FPGA DEBUGGING %
% \input{chapters/250_fpga_debugging}
% % ------------------------------------------------------------------------->>> %

% % <<< ---------------------------------------------------------------- AXI BUS %
% \input{chapters/260_axi_bus}
% % ------------------------------------------------------------------------->>> %
